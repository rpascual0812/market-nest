...
192	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiZW1haWwwMkBnbWFpbC5jb20iLCJzdWIiOjEzNiwiaWF0IjoxNjY3NTExMjEyLCJleHAiOjE2Njc1NTQ0MTJ9.uziltIusHBUxG_ZGvKcH9ITxAPOOlK86PSvsi_1JiTI	2022-11-04 17:33:32+08	2022-11-04 05:33:32.904489+08	136
\.
...
SELECT pg_catalog.setval('public.documents_pk_seq', 106, true);
...
SELECT pg_catalog.setval('public.logs_pk_seq', 36, true);
...
SELECT pg_catalog.setval('public.orders_pk_seq', 8, true);
...
SELECT pg_catalog.setval('public.product_documents_pk_seq', 28, true);
...
SELECT pg_catalog.setval('public.sessions_pk_seq', 192, true);
