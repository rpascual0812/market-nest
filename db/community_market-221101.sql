...
14	97d32c4b-1855-4d78-aa05-794b3e84e8b9	4	product	DragoFruit	2022-10-31 06:08:53.614001+08	f	1	173	Drago	0.00	0.00	0.00	1
...
16	4fcf443e-3a6d-4857-9318-033733ce96b1	19	product	Test Product 1	2022-10-31 06:15:12.009441+08	f	1	173	asdf	0.00	0.00	0.00	1
17	bef1d653-d20b-4b78-b26d-2670b97414d0	19	product	Product 2	2022-10-31 12:21:36.523741+08	f	1	173	Test	0.00	0.00	0.00	1
...
22	adaf3e31-0bdb-4a16-86cd-eaf9b1ebe718	20	looking_for	Product 3	2022-11-01 12:49:35.383889+08	f	2	173	Tes Prdut3	1000.00	1000.00	5000.00	1
24	1f66b675-72e8-4217-a8f0-92eebdbb143c	20	looking_for	Product 4	2022-11-01 12:58:15.188916+08	f	2	173	Test produt	1000.00	1000.00	5000.00	1
25	97d67717-389e-48e3-b18f-d1cd220b20c9	20	looking_for	Product 5	2022-11-01 13:46:05.480508+08	f	2	173	Test prduct	1000.00	1000.00	5000.00	1
26	db2cf2dc-553b-4c9b-a000-17987143bd60	20	looking_for	Product 6	2022-11-01 16:58:57.449599+08	f	2	173	Test	1000.00	1000.00	5000.00	1
\.
...
187	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiZW1haWwwMkBnbWFpbC5jb20iLCJzdWIiOjEzNiwiaWF0IjoxNjY3Mjk0OTI3LCJleHAiOjE2NjczMzgxMjd9.D334eXdxkEOLI1UJr2huR0g1Ss_I3N6SjHVaX3axBKM	2022-11-02 05:28:47+08	2022-11-01 17:28:47.293931+08	136
\.
...
6	orders	Pending	2022-10-25 06:28:39.31071+08	f	4
\.
...
1	5.00	20	21	2022-11-01 22:09:33.312034+08	Very good!
\.
...
SELECT pg_catalog.setval('public.accounts_pk_seq', 137, true);
...
SELECT pg_catalog.setval('public.documents_pk_seq', 95, true);
...
SELECT pg_catalog.setval('public.emails_pk_seq', 8, true);
...
SELECT pg_catalog.setval('public.logs_pk_seq', 32, true);
...
SELECT pg_catalog.setval('public.orders_pk_seq', 7, true);
...
SELECT pg_catalog.setval('public.product_documents_pk_seq', 24, true);
...
SELECT pg_catalog.setval('public.product_ratings_pk_seq', 3, true);
...
SELECT pg_catalog.setval('public.products_pk_seq', 26, true);
...
SELECT pg_catalog.setval('public.sessions_pk_seq', 187, true);
...
SELECT pg_catalog.setval('public.statuses_pk_seq', 6, true);
...
SELECT pg_catalog.setval('public.user_addresses_pk_seq', 12, true);
...
SELECT pg_catalog.setval('public.user_documents_pk_seq', 22, true);
...
SELECT pg_catalog.setval('public.users_pk_seq', 21, true);
